...
export function HeroSection() {
  return (
    <Link href="/shop" className="block relative h-screen w-full overflow-hidden bg-black group cursor-pointer">
      {/* Background image */}
      <div className="absolute inset-0 flex items-center justify-center p-4 md:p-8 bg-black">
        ...
        <img
          ...
          className="w-full h-full object-contain object-center rounded-2xl md:rounded-[2rem] group-hover:scale-[1.01] transition-transform duration-700"
        />
      ...
      <motion.div
        ...
        transition={{ delay: 1 }}
      >
        <span className="text-[10px] tracking-[0.3em] uppercase text-white/60">Shop Now</span>
        <motion.div
