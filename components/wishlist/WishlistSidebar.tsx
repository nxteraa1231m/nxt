        ...
        <>
          ...
          >
            ...
            <div className="px-5 py-4 border-b border-zinc-100 dark:border-zinc-900 flex items-center justify-between flex-shrink-0 bg-white dark:bg-zinc-950">
              ...
              <button
                onClick={closeWishlist}
                className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-900 text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-all cursor-pointer"
              >
                <X size={16} />
              </button>
            </div>
                ...
                <div className="h-full flex flex-col items-center justify-center text-center space-y-3 py-10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-1 max-w-[220px] mx-auto">
                      احفظ المنتجات التي تحبها هنا لتتمكن من العثور عليها بسهولة!
                    </p>
                  </div>
                  <button
                    onClick={closeWishlist}
                    className="px-5 py-2 bg-black text-white dark:bg-white dark:text-black rounded-xl text-xs font-bold hover:opacity-90 transition-all cursor-pointer"
                  >
                    تصفح المنتجات
                  </button>
                </div>
                ...
                wishlist.map((product) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex items-center gap-3 p-2.5 bg-zinc-50 dark:bg-zinc-900/60 rounded-xl border border-zinc-100 dark:border-zinc-900"
                    >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between mt-1.5">
                          ...
                          <button
                            ...
                            onClick={() => {
                              closeWishlist();
                              // Always navigate by product ID (unique) — never by slug
